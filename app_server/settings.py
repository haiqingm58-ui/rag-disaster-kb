...
class AppSettings:
    ...
    tavily_max_results: int = _int_env("TAVILY_MAX_RESULTS", 4)
    tavily_search_depth: str = os.getenv("TAVILY_SEARCH_DEPTH", "basic").lower()
    tavily_timeout_seconds: int = _int_env("TAVILY_TIMEOUT_SECONDS", 12)
